<template>
    <div class="menu">
        <div class="top">
            <span
                class="qtt-users"
            >Já somos {{ qtt_users > 999 ? "mais de mil" : qtt_users }} usuários distribuindo Intrigas</span>
            <ul>
                <li><a href="#">
                    <div class="link">
                        <span><svg viewBox="0 0 24 24" aria-hidden="true" class="r-13v1u17 r-4qtqp9 r-yyyyoo r-16y2uox r-8kz0gk r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-lrsllp"><g><path d="M23.643 4.937c-.835.37-1.732.62-2.675.733.962-.576 1.7-1.49 2.048-2.578-.9.534-1.897.922-2.958 1.13-.85-.904-2.06-1.47-3.4-1.47-2.572 0-4.658 2.086-4.658 4.66 0 .364.042.718.12 1.06-3.873-.195-7.304-2.05-9.602-4.868-.4.69-.63 1.49-.63 2.342 0 1.616.823 3.043 2.072 3.878-.764-.025-1.482-.234-2.11-.583v.06c0 2.257 1.605 4.14 3.737 4.568-.392.106-.803.162-1.227.162-.3 0-.593-.028-.877-.082.593 1.85 2.313 3.198 4.352 3.234-1.595 1.25-3.604 1.995-5.786 1.995-.376 0-.747-.022-1.112-.065 2.062 1.323 4.51 2.093 7.14 2.093 8.57 0 13.255-7.098 13.255-13.254 0-.2-.005-.402-.014-.602.91-.658 1.7-1.477 2.323-2.41z"></path></g></svg></span>
                        <span></span>
                    </div>
                </a></li>
                <li><a href="#">
                    <div class="link">
                        <span><svg viewBox="0 0 24 24" aria-hidden="true" class="r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M12 1.696L.622 8.807l1.06 1.696L3 9.679V19.5C3 20.881 4.119 22 5.5 22h13c1.381 0 2.5-1.119 2.5-2.5V9.679l1.318.824 1.06-1.696L12 1.696zM12 16.5c-1.933 0-3.5-1.567-3.5-3.5s1.567-3.5 3.5-3.5 3.5 1.567 3.5 3.5-1.567 3.5-3.5 3.5z"></path></g></svg></span>
                        <span>Página Inicial</span>
                    </div>
                </a></li>
                <li><a href="#">
                    <div class="link">
                        <span><svg viewBox="0 0 24 24" aria-hidden="true" class="r-1nao33i r-4qtqp9 r-yyyyoo r-lwhw9o r-dnmrzs r-bnwqim r-1plcrui r-lrvibr r-cnnz9e"><g><path d="M10.09 3.098L9.72 7h5.99l.39-4.089 1.99.187L17.72 7h3.78v2h-3.97l-.56 6h3.53v2h-3.72l-.38 4.089-1.99-.187.36-3.902H8.78l-.38 4.089-1.99-.187L6.77 17H2.5v-2h4.46l.56-6H3.5V7h4.21l.39-4.089 1.99.187zM14.96 15l.56-6H9.53l-.56 6h5.99z"></path></g></svg></span>
                        <span>Explorar</span>
                    </div>
                </a></li>
                <li><a href="#">
        ...
        <div v-if="logged_user" class="bottom">
            <User
                :user="logged_user"
                :enabled_infos="true"
            />
            <span class="qtt-posts-user">Você fez {{ qtt_posts_user }} postagens</span>
        </div>
    </div>
</template>
...
export default {
    ...
    props: ["logged_user", "qtt_users"],
    watch: {
        logged_user: {
            handler() {
                this.update_qtt_posts()
            },
            deep: true
        },
        qtt_users: {}
    ...
    methods: {
        login() {
            if (this.logged_user) {
                onInteractUser.$emit("sign-out")
            }
        },
        update_qtt_posts() {
            if (this.logged_user) {
                this.qtt_posts_user = this.logged_user.id_posts.length
            }
        }
    },
    created() {
